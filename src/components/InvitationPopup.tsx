                            ...
                            <div className="relative z-10 px-4 sm:px-6 py-5 sm:py-6 flex flex-col justify-center">
                                ...
                                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.5 }} className="text-center">
                                    <div className="mx-auto w-full max-w-lg">
                                        ...
                                        <p className="mt-1 text-[10px] sm:text-xs tracking-[0.16em] font-semibold text-black uppercase">Dengan hormat mengundang Anda</p>
                                    </div>
                                </motion.div>
                                ...
                                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45, duration: 0.5 }} className="text-center px-1 sm:px-3">
                                    <p className="text-xs sm:text-sm italic leading-relaxed text-black max-w-xl mx-auto">Suatu kehormatan bagi kami mengundang Anda pada momen istimewa ini.</p>
                                    <div className="mt-2">
                                        <p className="font-semibold text-sm sm:text-base text-burgundy">Pernikahan Kami</p>
                                        <p className="text-[11px] text-black font-bold sm:text-xs" style={{ WebkitTextStroke: '1.5px gray', paintOrder: 'stroke' }}>Minggu, 17 Oktober 2027</p>
                                    </div>
                                </motion.div>
