      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="relative w-full max-w-2xl bg-linear-to-b from-champagne/95 via-white/95 to-sage/5 backdrop-blur-md rounded-2xl p-0 shadow-2xl border border-white/80 overflow-hidden max-h-[76vh]"
          >
            {/* Decorative elements */}
            <motion.div
            ...
            <div className="grid grid-cols-1 md:grid-cols-2">
              <div className="relative overflow-hidden md:rounded-l-2xl h-28 sm:h-32 md:h-auto md:min-h-75">
              ...
              <div className="relative z-10 px-4 sm:px-6 py-5 sm:py-6 flex flex-col justify-center">
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15, duration: 0.5 }} className="text-center">
                  <div className="mx-auto w-full max-w-lg">
                    ...
                    <h1 className="text-2xl sm:text-3xl md:text-4xl font-serif text-burgundy leading-tight">Zahra & Akbar</h1>
                    <p className="mt-1 text-[10px] sm:text-xs tracking-[0.16em] font-semibold text-charcoal/60 uppercase">Dengan hormat mengundang Anda</p>
                  </div>
                </motion.div>
                ...
                <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.45, duration: 0.5 }} className="text-center px-1 sm:px-3">
                  <p className="text-xs sm:text-sm italic leading-relaxed text-charcoal/80 max-w-xl mx-auto">Suatu kehormatan bagi kami mengundang Anda pada momen istimewa ini.</p>
                  <div className="mt-2">
                    <p className="font-semibold text-sm sm:text-base text-burgundy">Pernikahan Kami</p>
                    <p className="text-[11px] sm:text-xs">Minggu, 17 Oktober 2027</p>
                  </div>
                </motion.div>
                ...
                <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 0.9, duration: 0.5 }} className="text-center text-[11px] text-charcoal/50 pt-2 italic">Lihat detail di halaman utama</motion.p>

                <p className="text-center text-[10px] text-charcoal/40 mt-1.5">Ketuk di luar popup atau tekan <span className="font-semibold">Esc</span> untuk menutup</p>
              </div>
            </div>
          </motion.div>
        </motion.div>
